 ...
 */
package com.gateway.payments.filter;
...
public class RESTCorsDemoResponseFilter implements ContainerResponseFilter {
    ...
    public void filter( ContainerRequestContext requestCtx, ContainerResponseContext responseCtx ) throws IOException {
        ...
        responseCtx.getHeaders().add( "Access-Control-Allow-Headers","Content-Type, Content-Range, Content-Disposition, Content-Description" );
    }
}
//- See more