...
public class RequestPINPADResponse  implements java.io.Serializable {
    private PinPadResponse requestPINPADResult;

    public RequestPINPADResponse() {
    }

    public RequestPINPADResponse(
           PinPadResponse requestPINPADResult) {
     ...
     */
    public PinPadResponse getRequestPINPADResult() {
        return requestPINPADResult;
    }
     ...
     */
    public void setRequestPINPADResult(PinPadResponse requestPINPADResult) {
        this.requestPINPADResult = requestPINPADResult;
    }
