...
public class CreditCardResourceH2H {
    ...
    public ResponseCreditCardProcess makePaymentSoap(String merchantUser, String merchantPassword, String merchantEndPoint, String merchantTransId, ProcessCreditCardH2HRequest jsonRequest) throws Exception {
        ...
        response.setResponseCode(responseH2HConverted.getStatusCode().equals("0000") ? "0" : responseH2HConverted.getStatusCode());
        response.setMessage(responseH2HConverted.getStatusDescription().contains("Approved") ? "Approved" : responseH2HConverted.getStatusDescription());
